...
const Register = ({
  ...
  return (
    <div
      className={`login_Page  flex absolute  z-[9999999] items-center justify-center h-screen w-screen bg-opacity-50 ${
        ...
        <form onSubmit={onRegister} className=" p-2 !sm:p-4 flex flex-col">
          ...
          <div className="pass_In px-0.5 h-9  overflow-y-hidden">
            <input
              ...
              id="Password"
              required
              className={`!sm:ml-3 rounded-md overflow-visible relative bottom-1 sm:bottom-0 px-0.5 h-7 w-full ${
                isDarkTheme ? " text-white bg-black " : " text-black bg-white"
              }`}
            />
            <span
          ...
          <div className="pass_In px-0.5 mb-1 h-9 overflow-y-hidden">
            <input
              ...
              id="Confirm_Password"
              required
              className={`!sm:ml-3 rounded-md px-0.5 h-7 relative bottom-1 sm:bottom-0 w-full ${
                isDarkTheme ? " text-white bg-black " : " text-black bg-white"
              }`}
            />
            <span
              ...
              className="relative z-100 bottom-[29px] sm:bottom-[28px] sm:left-[295px] left-[230px] text-2xl w-5  cursor-pointer"
              id="Confirm_Password">
          ...
          <button
            type="submit"
            className={`rounded-md hover:animate-pulse duration-75 transition-shadow py-1 hover:scale-105 w-full ${
