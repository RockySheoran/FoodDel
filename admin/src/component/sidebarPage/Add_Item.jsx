...
//   return (
//     <div className='add_item mx-3 md:ml-14 mt-5'>
...
//                     <img src={Image ? URL.createObjectURL(Image):assets.upload_area} alt="upload here image"  className='my-2 h-24 w-26 sm:w-24' />
//                     <div className="file grid content-end pb-2 ">

//                     <input onChange={(e) => setImage(e.target.files[0])} type="file" name="image" id="image" className='' required  />
...
//                 <input onChange={onChangeHandler} required value={data.name} type="text"  className='border border-gray-300 focus:border-red-500  focus:ring-red-500 rounded px-3 py-1 w-full outline-0 transition placeholder-gray-500 focus:ring-1 ' name='name' id='name' placeholder='Enter here name'/>
//             </div>
//             <div className="product_description flex flex-col gap-2 pb-3">
//                 <label htmlFor="description">Product description :</label>
//                 <textarea onChange={onChangeHandler} required value={data.description} name="description" className='border p-1 rounded border-gray-300 py-1 focus:border-red-500  focus:ring-red-500 focus:ring-1 outline-0 '  id="description" placeholder='Write content here' cols="50" rows="3"></textarea>

//             </div>
//             <div className="group grid grid-cols-2 gap-3">
//             <div className="product_category flex flex-col gap-2 ">
//                 <label htmlFor="category">Category:</label>
//                 <select onChange={onChangeHandler} value={data.category} required name="category" id="category" className='border  rounded-md h-8   focus:border-red-500  focus:ring-red-500 focus:ring-1 outline-0  '>
...
//                 <input onChange={onChangeHandler} value={data.price} required type="Number" name="price" id="price" placeholder='$20' className='border rounded-md py-1  pl-2  focus:border-red-500  focus:ring-red-500 focus:ring-1 outline-0 '/>
//             </div>
//             </div>

//             <button type='submit' className='border   *:  rounded-lg mt-4 bg-black text-white    w-20 py-1 '>Add</button>
